...
// const IPAddress='www.xingjiangzh.cn'//因为这里是要链接远程数据库，ip 地址是 mysql 的地址！！本地就是 127.0.0.1，服务器上就自己找找看
// const UserName='ylsh'
// const PWD='yzc6KPkrnKmrLyEz'
// const DBName='ylsh'
...
//   connection.query("select * from credithc_ylsh",function(error,results,fields){//执行查找语句
